    ...
    <div class="flex flex-1 items-center justify-end md:justify-between">
      <nav aria-label="Global" class="hidden md:block">
        <ul class="flex items-center gap-6 text-sm">
          ...
          <li>
            <a class="text-gray-500 transition hover:text-gray-500/75" href="/all-products"> Explore more </a>
          </li>

          <li>
            <a class="text-gray-500 transition hover:text-gray-500/75" href="/about-us"> About us </a>
          </li>
      ...
      <div class="flex items-center gap-4">
        <div class="sm:flex sm:gap-4">
          ...
          @if (auth()->check())
            ...
            <button wire:click="logout" class="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="size-8">
